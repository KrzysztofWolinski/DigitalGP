...
public class ExpressionTest {
	...
	@Test
	public void shouldReturnProperNegation() throws NoValueAssignedException {
		Attribute a = new Attribute("test", false);
		Expression e = new Expression(a, Operation.NOT, null);
